                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.update') }}" method="post">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control rounded-pill" id="exampleInputName" aria-describedby="nameHelp" name="nama" value="{{ $pengguna->name }}">
                            </div>
                            <div class="form-group mb-3">
                                <label for="exampleInputEmail1" class="form-label">Email Address</label>
                                <input type="email" class="form-control rounded-pill" id="exampleInputEmail1" name="email-address" value="{{ $pengguna->email }}">
                            </div>
                            <div class="form-group mb-3">
                                <label for="exampleInputPassword1" class="form-label">Password</label>
                                <input type="password" class="form-control rounded-pill" id="exampleInputPassword1" name="password">
                            </div>
